/**
 * Created by gaurav umrani on 14/10/17.
 */
const db = require('../models/models/contactdb_city');

module.exports.getCityname = function (callback) {
	db.find({},{'_id':1,'city':1},(err,doc)=>{
		if(err) throw err ;
